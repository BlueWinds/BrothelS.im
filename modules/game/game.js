...
define(['text!./intro.html', './schema', 'text!./new-form.html', 'text!./save-form.html', 'text!./load-form.html', 'content/game', 'core', 'libraries/cycle', 'libraries/ejs', 'core'], function(intro, Game, new_template, save_template, load_template, config) {
