...
Actions.Explore = {
  ...
  options: {
    Redlight: 'Redlight', //:"The red-light district. Though relatively small, it\'s quite busy since sex is the nation\'s primary product.",
    ...
    Garrison: 'Garrison' //: "The town guard, such as it is, is based out of an old castle on the opposite side of the city from Uptown."
  },
  tags: function() {
    var tags = {};
  ...
  results: {
    ...
    'morningSlums': {
      message: {
        ...
        text: "The Slums don\'t look so bad in the morning light. Nearly three-quarters of the population lives and works in this part of the city, afterall, so it can\'t be nearly as bad as its reputation suggests. You and <<- girl.name >> spend some time hunting for bargains at smaller, out of the way markets. Once your nose gets used to it, it\'s almost a pleasant place."
      },
      girl: {
        endurance: -6
      }
    ...
    'morningPark': {
      message: {
        ...
        text: "Clean and well cared for, the Central Park is always full of people jogging on the circular footpath around the outside, picnicking on the grass, or resting under the shade of trees. The two of you spend some time taking in the sights, spending a pleasant morning in the sun."
      },
      girl: {
        endurance: 4,
        happiness: 2
