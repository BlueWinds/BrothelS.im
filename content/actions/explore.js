...
Actions.Explore = {
  ...
  options: {
    'Redlight': "The redlight district. Though relatively small, it's quite busy since sex is the nation's primary product.",
    'Slums': "There are better parts of town, but none more populous or unwatched by the law.",
    'Docks': "As the primary port of an island nation, the port never sleeps.",
    'Market': "Anything can be bought or sold in the central market - if not in broad daylight, then at least in one of the smaller, nondescript buildings nearby.",
    'Park': "The crown maintains several large parks inside the city limits, at public expense.",
    'University': "Though unusual for such a small kingdom to maintain a presigious institution of learning, young male foreign nobles are oddly enthusiastic about going to school here...",
    'Uptown': "The best part of the city, raised on a hill above the smell and dirt of the rest of the city.",
    'Garrison': "The town guard and army, such as it is, are based out of an old castle on the opposite side of the city from Uptown."
  },
  tags: function() {
    var tags = {};
    tags[this.option.strToLower()] = 1;
    return tags;
  },
