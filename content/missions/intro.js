...
Missions.enduranceAndHappiness = {
  ...
  image: 'tired',
  start: {
    girlMax: { endurance: 30 }
  },
  description: "Kirino is starting to look a little bit worn out from all the work getting ready for the grand opening. You can There's only one cure for this, of course - time off. You should have her <strong>Rest</strong> a couple of times until she recovers most of her <<- T('endurance') >>. She'll automatically start Resting when her endurance becomes too low for her current action - but you may want to let her take some time off before she's completely exhausted.<br><br><em><<- T('endurance') >> doesn't affect anything directly, just disables actions other than <strong>Rest</strong> - you don't need to manage it carefully, especially since Rest will be automatically assigned as necessary.<br><br>High <<- T('happiness') >> on the other hand makes her less likely to refuse sex, and customers will enjoy themselves more a girl who enjoys her work. In addition to Resting, you can change a girl's daily wage by clicking on her picture or stats, then rolling the spinner up or down. A girl's demand for wages goes up as her stats raise - for now, Kirino is living off her savings and doesn't need to be paid, but this will change soon.</em>",
  end: {
    girlMin: {
      endurance: 80,
      happiness: 80
...
Missions.firstMoney = {
  ...
  description: "That's it - now that you've gotten familiar with her and gotten a feel for this new city, you're ready to start pimping Kirino. Time to tell her to start <strong>Streetwalking</strong> - you anticipate that this will be your main source of income for quote some time. Once you've closed this dialog, click on Kirino's picture in the lower left side of the screen. Notice the four sex types on the right-hand side of that dialog - enable <<- ['soft', 'hard'].CtoString('noun') >> so they have check-marks rather than Xs next to them. Sex acts further down the list pay more, but are more tiring and girls are more likely to refuse. Higher <<- T('obedience') >> and <span class='stat hard'><<- T('experience') >></span>, but most especially <span class='stat hard'><strong><<- T('libido') >></strong></span> for any given act makes refusal less likely.<br><br>Once that's done, set Kirino to <strong>Streetwalk</strong>.",
  end: {
    'soft experience': 31
  },
  success: {
...
Missions.cleanBuilding = {
  ...
  image: '/content/missions/firstBuilding.jpg',
  group: 'Introduction',
  description: "<blockquote>Hey, nice <<= g.buildings.Cfilter('status', 'Owned').Cfirst().name >>! Have you assigned me a room yet? If not, you can do that by clicking on the building and selecting me for one of the bedrooms. Once that's done, check back on my page, and you'll see I need a lot less money to be happy, since I don't have to pay for a room each night out of my own pocket.</blockquote><br><br>Looking aroung, you realize that the <<= g.buildings.Cfilter('status', 'Owned').Cfirst().name >> is a lot messier than you'd like. The last owner didn't exactly leave it spic and span, and it's been unoccupied for a while. Best to get all those stains off the walls - make a girl to <strong>Clean</strong> until it's shining.<br><br><em><<- T('clean') >> represents... well... I don't think you need an explanation here. The cleaner a building, the better of an effect it has on its residents - most buildings will raise <<- T('endurance') >> and <<- T('happiness') >>, while some have additional effects.</em>",
  end: {
    minDay: '+3'
  },
  success: {
