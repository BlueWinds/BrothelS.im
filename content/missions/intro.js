Missions.setFirstAction = {
  label: 'Give orders',
  description: "<blockquote>I'll guide you around the game a bit. In addition to my help, most labels and numbers can be hovered over for more information. The very first thing we need to do is get me started working - once you've closed this dialog, click on me (Kirino) in the lower left side of the screen. Once there, you'll see I'm scheduled to Rest in both the morning and evening. Set my morning action to Streetwalk, and I'll wander around the city looking for men willing to lighten their wallets for me.<br><br>Any changes you make are applied immediately - no need to save them. While you're there, also set what types of sex acts I should perform - click <%= Game.strings.noun.soft %> and <%= Game.strings.noun.hard %> so they have checkmarks rather than Xs next to them. Sex acts further down the list pay more, but are more tiring and girls are more likely to refuse. Higher <%= Game.strings.obedience %>, <%= Game.strings.noun.libido %> and <%= Game.strings.noun.experience %> with any given act makes refusal less likely.<br><br>Once you've given me orders (to Streetwalk in the morning and to do <%= Game.strings.noun.soft %> and <%= Game.strings.noun.hard %> with customers), click Next Turn back on the main screen. This message will remain available under the \"missions\" button until completed.</blockquote>",
