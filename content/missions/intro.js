Missions.setFirstAction = {
  label: 'Welcome',
  description: "<blockquote>Hiya! Since you're new here, I'll guide you around the game a bit. You can pull up each task I give you until you complete it by clicking Missions from the main screen. The very first thing we need to do is get me started working - once you've closed this dialog, click on me in the lower left side of the screen. You'll see a lot of numbers there - you can hover over any of them to see what they mean.<br><br>First, notice the four main sex types on the right-hand side of that dialog - click <<- ['soft', 'hard'].CtoString('noun') >> so they have check-marks rather than Xs next to them. Sex acts further down the list pay more, but are more tiring and girls are more likely to refuse. Higher <<- T('obedience') >>, <<- T('libido') >> and <<- T('experience') >> with any given act makes refusal less likely. Next, set my morning action to Streetwalk, and I'll wander around the city looking for men willing to lighten their wallets for me.<br><br>Any changes you make are applied immediately - no need to save them. Once you've given me orders, click Next Turn back on the main screen.</blockquote>",
