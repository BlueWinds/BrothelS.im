...
//     },
  ...
  // One special trick you can use is to leave out both the description and image - in this case, the "mission" won't send out a message that it's started, or show up on the mission list. You can use this to set up "delayed triggers" - have an event start a mission, for example, and some time later have the mission end and send the player message.
