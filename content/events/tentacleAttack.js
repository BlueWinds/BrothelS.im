// Don't touch this line. Things will explode.
define([], [
  ...
  {
    // The _id of an event is the "machine readable" name of this event. It must be unique - two events with the same _id would overwrite eachother.
    _id: 'tentacleAttack',
