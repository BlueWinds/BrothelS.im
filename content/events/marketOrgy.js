    ...
    { // soft
      message: [
        ...
        },
        {
          ...
          image: '<<- girl.image("soft") >>',
          label: 'Marketplace Gloryhole',
          text: "You get some odd looks, standing in the men's restroom collecting money for use of a specific stall, but the slurping, sucking sounds and occasional moan as <<- girl.name >> fingers herself on the other side of the wall make it abundantly clear why someone would pay to enter. She sucks more than a dozen cocks, never seeing their owners, before you look up at the time - the two of you have to go. After finishing a final customer off, you tell the disappointed line that shows over, and enter the stall yourself. <<- girl.name >> pouts a bit when you tell her there's no more cocks forthcoming - it's clear she'd love nothing more than to do this all day long."
        }
      ],
      girl: {
        endurance: -16,
