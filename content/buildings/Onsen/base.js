...
Buildings.Onsen = {
  ...
  description: "<p>While there are no natural hot-springs in the area, that didn\'t stop one enterprising wizard from expending vast reserves of magical power to create one himself.</p><p>Unfortunately, his vast power was not matched by vast business sense, and he quickly lost all his money and the building soon after, and it has been sitting vacant ever since. The Guild is now offering it at a steep discount to anyone who can clean it up and put it to good use.</p><p>Though the building is hard to keep clean (expect to keep one girl cleaning the building full time), visitors using the hot-spring will provide a good income and girls living slowly become more <<- __('-modesty', 'adj') >> and <<- __('charisma', 'adj') >>.</p>"
};
