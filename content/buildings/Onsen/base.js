define({
  ...
  description: "<p>While there are no natural hot-springs in the area, that didn't stop one enterprising wizard from expending vast reserves of magical power to create one himself.</p><p>Unfortunately, his vast power was not matched by vast business sense, and he quickly lost all his money and the building soon after, and it has been sitting vacant ever since. The Guild is now offering it at a steep discount to anyone who can clean it up and put it to good use.</p><p>Though the building is <strong>hard to keep clean</strong>, visitors using the hotspring will provide a good income and the Charisma of girls living here will rise slowly!</p>"
});